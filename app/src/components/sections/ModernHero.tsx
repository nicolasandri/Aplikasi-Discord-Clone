...
import { TextScramble, GlitchText, MagneticButton, AnimatedCounter } from '@/components/animations';
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-modern mb-6 group cursor-pointer hover:bg-white/10 transition-colors"
            >
              <motion.div
            ...
            >
              ...
              <MagneticButton
                className="group px-8 py-4 glass-modern text-cyan-400 font-semibold text-lg rounded-xl hover:bg-cyan-500/10 transition-all border border-cyan-500/30"
              >
            ...
            >
              {[
                { icon: Users, value: 500, suffix: '+', label: 'Tim Menggunakan' },
                { icon: MessageSquare, value: 100000, suffix: '+', label: 'Pesan Terkirim' },
          ...
          >
            ...
            >
              ...
              {/* Placeholder for image - in real app, replace with actual screenshot */}
              <div className="relative w-full h-[400px] rounded-3xl overflow-hidden bg-gradient-to-br from-[#0a0c10] to-[#15192a] flex items-center justify-center">
                <div className="text-center">
                  <div className="text-6xl mb-4">💬</div>
                  <p className="text-gray-400">WorkGrid Platform</p>
                </div>
              </div>
            ...
            <motion.div
              className="absolute -top-4 -right-4 glass-modern rounded-xl p-4 border border-cyan-500/30"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            {/* Floating users card */}
            <motion.div
              className="absolute -bottom-4 -left-4 glass-modern rounded-xl p-4 border border-cyan-500/30"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
