            ...
            <div className="bg-[#050608]/95 backdrop-blur-xl border-b border-cyan-500/20 mx-4 rounded-2xl overflow-hidden">
              <div className="px-4 py-6 space-y-4">
                ...
                <motion.div
                  ...
                  className="pt-4 border-t border-cyan-500/20 space-y-2"
                >
                  <button
                    onClick={() => (window.location.href = '/login')}
                    className="w-full text-gray-300 hover:text-white transition-colors text-sm font-medium py-2"
                  >
                    Masuk
                  </button>
                  <button
                    onClick={() => (window.location.href = '/login')}
                    className="w-full px-6 py-2.5 bg-gradient-to-r from-cyan-500 to-cyan-400 text-[#050608] font-semibold text-sm rounded-lg"
                  >
                    Daftar Gratis
                  </button>
                </motion.div>
