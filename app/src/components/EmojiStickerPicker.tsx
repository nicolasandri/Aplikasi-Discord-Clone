...
export function EmojiStickerPicker({ onSelectEmoji, onSelectSticker, serverId }: EmojiStickerPickerProps) {
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent 
        className="w-[420px] h-[480px] p-0 bg-[#2f3136] border-[#202225] overflow-hidden" 
        align="end"
        side="top"
      >
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full h-full flex flex-col">
          ...
          <div className="flex items-center justify-between px-4 py-2 border-b border-[#202225]">
            <TabsList className="bg-transparent p-0 gap-1">
              <TabsTrigger 
                value="emoji" 
                className="data-[state=active]:bg-[#40444b] text-[#b9bbbe] data-[state=active]:text-white px-4 py-1.5 rounded-md text-sm"
              >
