...
echo 2. Memiliki akses SSH ke VPS 152.42.242.180
echo.
...
scp frontend-update.tar.gz root@152.42.242.180:/tmp/

echo.
echo 🚀 Deploying on VPS...
ssh root@152.42.242.180 "cd /tmp && tar -xzf frontend-update.tar.gz -C /opt/workgrid/nginx/html/ && rm frontend-update.tar.gz && docker restart discord_clone_frontend"
